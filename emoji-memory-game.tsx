...
export default function EmojiMemoryGame() {
  ...
  return (
    <div className="container mx-auto p-4 text-gray-200">
      <h1 className="text-3xl font-bold mb-4 text-center text-gray-100">Emoji Memory Game</h1>
      <div className="mb-4 flex justify-between items-center">
        <p className="text-lg">Moves: {moves}</p>
        <p className="text-lg">
          Matched Pairs: {matchedPairs}/{emojis.length}
        </p>
        <Button onClick={resetGame} className="bg-gray-700 hover:bg-gray-600 text-gray-200">
          Reset Game
        </Button>
      </div>
        ...
        {cards.map((card) => (
          <Card
            ...
            className={`h-24 flex items-center justify-center text-4xl cursor-pointer transition-all duration-300 ${
              card.isFlipped ? "bg-gray-700 text-gray-200" : "bg-gray-800 text-gray-800"
            }`}
